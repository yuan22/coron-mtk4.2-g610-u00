...
.field mVibrationIntensityService:Lcom/mediatek/audioprofile/IVibrationIntensityService;
...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/StatusBarManagerService;Lcom/android/server/LightsService;)V
    ...
    .line 155
    iput-object v6, p0, Lcom/android/server/NotificationManagerService;->mVibrationIntensityService:Lcom/mediatek/audioprofile/IVibrationIntensityService;
    ...
    iput-object v5, p0, Lcom/android/server/NotificationManagerService;->connection:Landroid/content/ServiceConnection;
...
.method changeVibrationIntensity(I)Z
    .locals 6
    .parameter "level"
    ...
    .line 1718
    iget-object v3, p0, Lcom/android/server/NotificationManagerService;->mVibrationIntensityService:Lcom/mediatek/audioprofile/IVibrationIntensityService;
    ...
    invoke-interface {v3, p1}, Lcom/mediatek/audioprofile/IVibrationIntensityService;->changeVibrationIntensity(I)Z
    ...
    const-string v5, "changeVibrationIntensity return true success to level = "
    ...
    const-string v4, "changeVibrationIntensity return false fail to change vibration intensity"
...
.method public enqueueNotificationInternal(Ljava/lang/String;IILjava/lang/String;ILandroid/app/Notification;[II)V
    ...
    const v7, #android:drawable@stat_sys_download_done#t
    ...
    :goto_d
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/NotificationManagerService;->isVibrationEnabled()Z

    move-result v38

    .line 1226
    .local v38, vibrationEnabled:Z
    if-eqz v38, :cond_18

    .line 1228
    const-string v7, "NotificationService"

    const-string v8, "vibrationEnabled = true"
    ...
    invoke-virtual {v0, v7}, Lcom/android/server/NotificationManagerService;->getVibrationIntensity(Ljava/lang/String;)I

    move-result v39

    .line 1232
    .local v39, vibrationIntensity:I
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/NotificationManagerService;->vibrationIntensityBindService()V
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/NotificationManagerService;->changeVibrationIntensity(I)Z

    .line 1237
    .end local v39           #vibrationIntensity:I
    :cond_18
    if-nez v37, :cond_19
    ...
    const-string v9, "first vibration  vibrationEnabled = "
    ...
    const-string v9, " convertSoundToVibration = "
    ...
    .line 1273
    const-string v7, "general_vibration_intensity"
    ...
    .line 1274
    .restart local v39       #vibrationIntensity:I
    move-object/from16 v0, p0
    ...
    .line 1276
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/NotificationManagerService;->vibrationIntensityUnBindService()V
    ...
    .end local v38           #vibrationEnabled:Z
    .end local v39           #vibrationIntensity:I
    :cond_1e
    move-object/from16 v0, p0
    ...
    .restart local v38       #vibrationEnabled:Z
    :cond_2c
    :try_start_11
    move-object/from16 v0, p0
    ...
    const-string v9, "second vibration  vibrationEnabled = "
...
.method getVibrationIntensity(Ljava/lang/String;)I
    .locals 2
    .parameter "type"
...
.method isVibrationEnabled()Z
    ...
    invoke-virtual {p0, v1}, Lcom/android/server/NotificationManagerService;->getVibrationIntensity(Ljava/lang/String;)I
...
.method vibrationIntensityBindService()V
    .locals 4
    ...
    const-class v1, Lcom/mediatek/audioprofile/IVibrationIntensityService;
    ...
    iget-object v2, p0, Lcom/android/server/NotificationManagerService;->connection:Landroid/content/ServiceConnection;
...
.method vibrationIntensityUnBindService()V
    .locals 3
